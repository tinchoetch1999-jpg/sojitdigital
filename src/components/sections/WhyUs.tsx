        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full border border-primary/30 bg-primary/5">
              <span className="text-sm text-primary/80">¿Por qué elegirnos?</span>
            </div>
          ...
          >
            {differentiators.map((item, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="p-6 rounded-xl border border-border/50 bg-card/50 backdrop-blur-sm h-full transition-all duration-300 hover:border-primary/30 hover:bg-primary/5">
