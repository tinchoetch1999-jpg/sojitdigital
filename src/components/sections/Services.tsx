...
import { Monitor, Cog, Megaphone, ArrowRight } from "lucide-react";
      ...
      <div className="container px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full border border-border bg-secondary/50">
            <span className="text-sm text-muted-foreground">Nuestros servicios</span>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {services.map((service, index) => (
            ...
            >
              <div className="relative h-full p-8 rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm transition-all duration-500 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/5">
                {/* Top accent line */}
                ...
                <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center mb-6 transition-all duration-300 group-hover:bg-primary/20">
