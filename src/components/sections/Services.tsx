...
const services = [
  ...
  },
  {
    ...
    description: "Potenciamos tu negocio con inteligencia artificial. Automatizamos procesos, integramos sistemas y desplegamos agentes que trabajan por vos las 24 horas.",
    features: [
      "Automatizaciones",
      "Agentes de IA",
      "Chatbots",
  ...
  },
  {
    ...
    description: "Llevamos tu presencia digital al siguiente nivel. Desde sitios web hasta campañas que generan resultados medibles para tu negocio.",
    features: [
      "Desarrollo Web",
